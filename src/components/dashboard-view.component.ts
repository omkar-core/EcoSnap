   ...
   template: `
    <div class="h-full overflow-y-auto pb-32 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 font-inter">
      ...
      <div class="px-6 space-y-6">
        ...
        <!-- Global Eco-Wave Challenge -->
        <div class="bg-gradient-to-br from-indigo-900/60 to-purple-900/60 border border-indigo-500/30 rounded-3xl p-5 relative overflow-hidden shadow-[0_10px_30px_rgba(99,102,241,0.2)] group transition-all">
           <!-- Cyberpunk Glitch Backing -->
           <div class="absolute right-0 top-0 bottom-0 w-32 bg-[repeating-linear-gradient(45deg,transparent,transparent_10px,rgba(99,102,241,0.1)_10px,rgba(99,102,241,0.1)_20px)] opacity-50 group-hover:opacity-100 transition-opacity"></div>
           
           <div class="relative z-10">
              <div class="flex items-center justify-between mb-2">
                 <h3 class="text-white font-black text-sm uppercase tracking-widest flex items-center gap-2 drop-shadow-md">
                    <span class="animate-pulse">🌊</span> Eco-Wave
                 </h3>
                 <span class="text-xs font-mono font-bold text-indigo-300 bg-indigo-950/80 px-2 py-1 rounded border border-indigo-500/50">
                    23h 45m LEFT
                 </span>
              </div>
              <p class="text-[10px] text-indigo-200 uppercase tracking-wider mb-4 font-bold opacity-80">Global Objective: Clear 5,000kg of Plastics</p>
              
              <div class="h-4 bg-slate-900/80 rounded-full overflow-hidden border border-indigo-500/30 relative">
                 <div class="absolute inset-0 bg-[repeating-linear-gradient(45deg,transparent,transparent_10px,rgba(255,255,255,0.1)_10px,rgba(255,255,255,0.1)_20px)] z-10"></div>
                 <div class="h-full bg-gradient-to-r from-cyan-500 to-indigo-500 rounded-full transition-all duration-[2000ms] w-[78%]"></div>
              </div>
              <div class="flex justify-between items-center mt-2 text-xs font-mono font-bold">
                 <span class="text-cyan-400">3,900kg Cleaned</span>
                 <span class="text-indigo-400">Bonus: +500 XP</span>
              </div>
           </div>
        </div>
